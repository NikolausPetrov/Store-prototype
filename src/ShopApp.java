...
public class ShopApp {
    public static void main(String[] args) {
        ...
        // Принцип DRY: Метод addProduct используется многократно для добавления продуктов. Это предотвращает дублирование кода, так как добавление продукта реализовано в одном месте.
    ...
    // Принцип единственной ответственности (Single Responsibility Principle): Метод printProductDetails отвечает только за вывод информации о продукте.
